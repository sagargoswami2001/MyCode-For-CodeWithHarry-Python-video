...
print(myDict["Hungry"])
print(myDict["Age"])
myDict["Other Members"] = ["Superman", "Wonder Woman", "Batman", "Green Lantern"]# Dictionaries can be changed/Modified(mutable)
print(myDict["Other Members"])# Printing List From Dictionary 
print(myDict["Co-op Team"]["Nightwing"])# printing Nested Dictionary the elements of Nested Dictionary can be accessed by a 2nd []
